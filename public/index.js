        ...
        let currentVisibleMonth = null; // tracked by IntersectionObserver
        ...
        const DEFAULT_CATEGORY = { color: '#787774', colorLight: '#ebeced' };
        let CATEGORY_CONFIG = {};
        const activeCategories = new Set();

        function buildCategoriesFromEvents() {
            const seen = new Map();
        ...
        const STATE = {
            ...
            weekElements: new Map(),    // weekKey string -> DOM element
            BUFFER_WEEKS: 16,
            MAX_WEEKS: 60,
            observers: {},
        };
        ...
        function thursdayOfWeek(sundayDate) {
        ...
        function insertWeekRowSorted(row, weekKey) {
            const container = document.getElementById('scrollContainer');
            const sentinelBottom = document.getElementById('sentinelBottom');
            const existingWeeks = Array.from(container.querySelectorAll('.week-row'));
            let inserted = false;
            for (const existing of existingWeeks) {
                if (existing.dataset.week > weekKey) {
        ...
        function applyDayEventChips(dayEl, allDayEvents) {
        ...
        function renderWeekRow(sundayDate) {
            ...
            for (let d = 0; d < 7; d++) {
                ...
                dayEl.addEventListener('click', () => {
                    document.querySelectorAll('.calendar-day.selected').forEach(el => el.classList.remove('selected'));
                    dayEl.classList.add('selected');
                    const visible = getVisibleEventsForDate(dayEl.dataset.date);
                    if (visible.length > 0) {
        ...
        function renderWeeks(centerDate, direction) {
        ...
        function prependWeeks(count) {
            ...
            const scrollArea = document.getElementById('calendarArea');
        ...
        function setupMonthHeaderObserver() {
            const scrollArea = document.getElementById('calendarArea');
            ...
            function updateVisibleMonth() {
                ...
                if (closestRow) {
                    ...
                    if (monthKey !== currentVisibleMonth) {
                        ...
                        document.querySelectorAll('.calendar-day[data-date-month]').forEach(cell => {
        ...
        function scrollWeekIntoView(weekEl, behavior) {
            const scrollArea = document.getElementById('calendarArea');
        ...
        function scrollToDate(targetDate, behavior) {
        ...
        function attachButtonHandlers() {
            ...
            function toggleSidebar() {
                ...
                const calToolbar = document.getElementById('calendarToolbar');
        ...
        function renderSearchResults(query) {
            ...
            if (!query) {
                ...
                const upcoming = eventsData
                    .map(e => ({ ...e, parsedDate: parseDtstart(e.dtstart) }))
        ...
        function createSearchResultItem(evt) {
        ...
        function renderMiniCalendar() {
            ...
            // Current month days
            const visibleMonthKey = currentVisibleMonth || getMonthKey(new Date());
            const miniMonthKey = getMonthKey(miniCalDate);
        ...
        function renderUpcomingEvents() {
            ...
            const upcoming = eventsData.map(e => {
                ...
                return { ...e, parsedDate: parsed, isAllDay: e.dtstart && !e.dtstart.includes('T') };
            })
